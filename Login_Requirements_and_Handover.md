...
**Done:** Documented required fields for the team page (team name, project name, per-member photo/name/role, short blurb) and confirmed login work is styling-only, no auth logic changes.
